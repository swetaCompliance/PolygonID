...
class ProofService {
    ...
    async prepareMerklizedQuery(query, credential, opts) {
        ...
        if (parsedQuery.fieldName) {
            path = await js_jsonld_merklization_1.Path.getContextPathKey(encoding_1.byteDecoder.decode(ldContext), credential.type[1], parsedQuery.fieldName, opts);
        }
    ...
    async loadLdContextFromJSONSchema(jsonSchemaURL, opts) {
